...
def main():
    parser = argparse.ArgumentParser(description="Solve Cloudflare Turnstile using cfsolver SDK")
    parser.add_argument("--proxy", dest="task_proxy", help="Task proxy for solver (e.g. http://user:pass@host:port)")
